...
package Scanner.Calendar is

   --type Time is private;
   -- in Gnat 3.15 Ada.Calendar, this is private.  But we need to access it
   -- in order to convert times to strings inside BUSH.
