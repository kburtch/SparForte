...
begin
  ...
  identifiers( teams_member_t ).store.value := to_unbounded_string( "18" );
  ...
  identifiers(  teams_member_desc_t ).store.value := to_unbounded_string( "1" );
  ...
  identifiers(  teams_member_skills_t ).store.value := to_unbounded_string( "2" );
  ...
  identifiers(  teams_member_lang_t ).store.value := to_unbounded_string( "3" );

  declareIdent( teams_member_id_t, "teams.member.id", natural_t, subClass );
  identifiers(  teams_member_id_t ).field_of := teams_member_t;
  identifiers(  teams_member_id_t ).store.value := to_unbounded_string( "4" );
  ...
  identifiers(  teams_member_prefcontact_t ).store.value := to_unbounded_string( "5" );
  ...
  identifiers(  teams_member_email_t ).store.value := to_unbounded_string( "6" );
  ...
  identifiers(  teams_member_sec_email_t ).store.value := to_unbounded_string( "7" );
  ...
  identifiers(  teams_member_prefname_t ).store.value := to_unbounded_string( "8" );
  ...
  identifiers(  teams_member_full_t ).store.value := to_unbounded_string( "9" );
  ...
  identifiers(  teams_member_chair_t ).store.value := to_unbounded_string( "10" );
  ...
  identifiers(  teams_member_nickname_t ).store.value := to_unbounded_string( "11" );
  ...
  identifiers(  teams_member_business_phone_t ).store.value := to_unbounded_string( "12" );
  ...
  identifiers(  teams_member_messaging_t ).store.value := to_unbounded_string( "13" );
  ...
  identifiers(  teams_member_teams_t ).store.value := to_unbounded_string( "14" );
  ...
  identifiers(  teams_member_manager_t ).store.value := to_unbounded_string( "15" );
  ...
  identifiers(  teams_member_roles_t ).store.value := to_unbounded_string( "16" );
  ...
  identifiers(  teams_member_active_t ).store.value := to_unbounded_string( "17" );

  declareIdent( teams_member_active_t, "teams.member.is_team", boolean_t, subClass );
  identifiers(  teams_member_active_t ).field_of := teams_member_t;
  identifiers(  teams_member_active_t ).store.value := to_unbounded_string( "18" );
