...
--     Put_Line( "  " & bold( "command" ) & " cmd" );
     ...
     content( e, "${X|} - replace with rounded value of X." );
     content( e, "${X||} - replace with absolute value of X." );
     content( e, "${X|^} - replace with ceiling of X." );
     content( e, "${X|,} - replace with floor of X." );
     ...
     content( e, "subtype newtype is [abstract|constant|limited] oldtype [affirm...end affirm]" );
     ...
     description( e, "The type statement will create a new type that is " &
                ...
                "See also subtypes.");
     content( e, "type newtype is new [abstract|constant|limited] oldtype [affirm...end affirm]" );
     content( e, "type newtype is ( enum1 [,enum2...] [affirm...end affirm] )" );
     content( e, "type newtype is [abstract|constant|limited] record field1 : type1 [;field2...] end record|newtype" );
     content( e, "type newtype is [abstract|constant|limited] array( low..high) of item_type [:= oldarray|(item,...)]" );
     seeAlso( e, "doc/ref_typedecl.html" );
     endHelp( e );
     ...
     content( e, "append( v, e [,n] )", "append_elements( v, e [,n] )" );
     content( e, "append_vector( v1, v2 )", "assign( t, s )" );
     content( e, "capacity( v )", "clear( v )" );
     content( e, "b := contains( v, e )", "decrement( v, i [,n] )" );
     content( e, "delete( v, c ) | ( v, i [, n] )", "delete_first( v, n )" );
     content( e, "delete_last( v, n )", "e := element( c ) | ( v, i )" );
     content( e, "b := equal( v1, v2 )", "find( v, e, c1, c2 )" );
     content( e, "find_index( v, e, v1, i2 )", "first( v, c )" );
     content( e, "e := first_element( v )", "i := first_index( v )" );
     content( e, "flip( v )", "b := has_element( c )" );
     content( e, "increment( v, i [,n] )", "insert( v, i, e [, n] )" );
     content( e, "insert_before( v, c, e [, n] )", "insert_before_and_mark( v, c, e, c2 [, n] )" );
     content( e, "insert_space( v, c, c2, [, n] )", "insert_space( v, i [,n] )" );
     content( e, "insert_vector( v, c, v2 )", "insert_vector_and_mark( v, c, v2, c2 )" );
     content( e, "b := is_empty( v )", "last( v, c )" );
     content( e, "e := last_element( v )", "i := last_index( v )" );
     content( e, "c := length( v )", "move( v1, v2 )" );
     content( e, "next( c )", "epend( v, e [,n] )" );
     content( e, "prepend_elements( v, e [,n] )", "previous( c )" );
     content( e, "reserve_capacity( v, n )", "reverse_elements( v )" );
     content( e, "reverse_find( v, e, c1, c2 )", "reverse_find_index( v, e, v1, i2 )" );
     content( e, "set_length( v, n )", "swap( v, i1, i2 | v, c1, c2 )" );
     content( e, "i := to_index( v, c )", "to_vector( v, e, n )" );
