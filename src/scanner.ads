...
function getDataFlowName return aDataFlowName;
function getDataFlowName( b : block ) return aDataFlowName;
-- return the name of the given flow
...
type blockDeclaration is record
  ...
  flowName        : aDataFlowName := noDataFlow;
