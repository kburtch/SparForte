------------------------------------------------------------------------------
-- BUSH Command_Line Package Parser                                         --
--                                                                          --
-- Part of BUSH                                                             --
------------------------------------------------------------------------------
--                                                                          --
...
--                                                                          --
------------------------------------------------------------------------------
-- CVS: $Id: parser_cmd.ads,v 1.2 2005/02/11 02:59:25 ken Exp $
...
procedure ParseArgument( result : out unbounded_string );
procedure ParseArgument_Count( result : out unbounded_string );
procedure ParseCommand_Name( result : in out unbounded_string );
procedure ParseSetExitStatus;
procedure ParseEnvironment_Count( result : out unbounded_string );
procedure ParseEnvironment_Value( result : out unbounded_string );
