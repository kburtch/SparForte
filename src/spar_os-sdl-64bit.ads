...
-- 64-bit version: GCC does some data alignment that Ada does not so extra  --
-- pad bytes are inserted here.                                             --
--                                                                          --
-- Part of SparForte                                                        --
------------------------------------------------------------------------------
--                                                                          --
...
type SDL_Palette is record
     ncolors : int;
     pad1,pad2,pad3,pad4  : Uint8;
     colors  : SDL_Color_Ptr; -- actually, an array of colours
end record;
pragma pack( SDL_Palette );
-- on x86_64 GCC, this struct is padded to multiple of 8 (39 up to 48)
for SDL_Palette'size use 16*8;
...
type SDL_PixelFormat is record
        palette : SDL_Palette_Ptr;                       -- x86_64 offset  0
        BitsPerPixel : Uint8;                            --        offset  8
        BytesPerPixel : Uint8;                           --        offset  9
        Rloss : Uint8;                                   --        offset 10
        Gloss : Uint8;                                   --        offset 11
        Bloss : Uint8;                                   --        offset 12
        Aloss : Uint8;                                   --        offset 13
        Rshift: Uint8;                                   --        offset 14
        Gshift: Uint8;                                   --        offset 15
        Bshift: Uint8;                                   --        offset 16
        Ashift: Uint8;                                   --        offset 17
        pad1,pad2  : Uint8;
        Rmask : SDL_RGB_Mask;                            --        offset 20
        Gmask : SDL_RGB_Mask;                            --        offset 24
        Bmask : SDL_RGB_Mask;                            --        offset 28
        Amask : SDL_RGB_Mask;                            --        offset 32
        colorkey : SDL_Generic_Pixel;                    --        offset 36
        alpha : alpha_transparency;                      --        offset 40
        pad3,pad4,pad5,pad6,pad7,pad8,pad9  : Uint8;
end record;
pragma pack( SDL_PixelFormat );
-- on x86_64 GCC, this struct is padded to multiple of 8 (39 up to 48)
for SDL_PixelFormat'size use 384;
...
type SDL_Surface is record
        flags     : SDL_Surface_Flag;                    -- x86_64 offset  0
        pad1,pad2,pad3,pad4  : Uint8;
        format    : System.Address;                      --        offset  8
        w, h      : int;                                 --        offset 16
        pitch     : Uint16;                              --        offset 24
        pad5,pad6,pad7,pad8,pad9,pad10  : Uint8;
        pixels    : System.Address;                      --        offset 32
        offset    : int;                                 --        offset 40
        pad11,pad12,pad13,pad14 : Uint8;
        hwdata    : System.Address;                      --        offset 48
        clip_rect : SDL_Rect;                            --        offset 56
        unused1   : Uint32;                              --        offset 64
        locked    : Uint32;                              --        offset 68
        map       : Private_Ptr;                         --        offset 72
        format_version : unsigned;                       --        offset 80
        refcount  : int;                                 --        offset 84
end record;
pragma pack( SDL_Surface );
-- on x86_64 GCC, this struct is padded to multiple of 8 (74 up to 88)
for SDL_Surface'size use 704;
...
type SDL_VideoInfo is record
        hw_available  : boolean;                         -- x86_63 offset  0
        wm_available  : boolean;                         -- these are bits
        UnusedBits1_1 : boolean;                         -- (16 of them)
        ...
        blit_sw_A     : boolean;
        blit_fill     : boolean;
        UnusedBits3   : Uint16;                          --        offset 2
        video_mem     : Uint32;                          --        offset 4
        vfmt          : System.Address;                  --        offset 8
        current_w     : int;
        current_h     : int;
end record;
pragma pack( SDL_VideoInfo );
-- on x86_64 GCC, this struct is padded to multiple of 8 (16 up to 32)
for SDL_VideoInfo'size use 192;
...
type SDL_Overlay is record
        format : SDL_Overlay_Type;                       -- x86_64 offset  0
        w, h   : int;                                    --        offset  4
        planes : int;                                    --        offset 12
        pitches: System.Address;                         --        offset 16
        pixels : System.Address;                         --        offset 24
        hwfuncs: Private_Ptr;                            --        offset 32
        hwdata : Private_Ptr;                            --        offset 40
        hw_overlay : Uint32; -- only bit 1 used                    offset 48
        pad1,pad2,pad3,pad4  : Uint8;
end record;
pragma pack( SDL_Overlay );
-- on x86_64 GCC, this struct is padded to multiple of 8 (52 up to 56)
for SDL_Overlay'size use 448;
